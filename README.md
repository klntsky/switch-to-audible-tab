# Switch to audible tab [![Mozilla Add-on Users](https://img.shields.io/amo/users/switch-to-audible-tab?label=Users%20on%20Firefox)](https://addons.mozilla.org/en-US/firefox/addon/switch-to-audible-tab/) [![Chrome Web Store Users](https://img.shields.io/chrome-web-store/users/obhmhiijebijngjodncffkecfiolonom?label=Users%20on%20Chrome)](https://chrome.google.com/webstore/detail/switch-to-audible-tab/obhmhiijebijngjodncffkecfiolonom)
...
The suites run against real browsers. Fetch the pinned browsers and driver
once, then run them:
